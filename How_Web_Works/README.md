...
| No.   | Questions                                                                        |
| ----- | -------------------------------------------------------------------------------- |
| 1.    | [Google's 'g' key is pressed](#googles-g-key-is-pressed)                         |
| 2.    | [When you hit 'Enter'](#when-you-hit-enter)                                      |
| 3.    | [Parse the URL](#parse-the-url)                                                  |
| 4.    | [Check HSTS list (deprecated)](#check-hsts-list-deprecated)                      |
| 5.    | [DNS lookup](#dns-lookup)                                                        |
| 6.    | [Opening of a socket + TLS handshake](#opening-of-a-socket--tls-handshake)       |
| 7.    | [HTTP protocol](#http-protocol)                                                  |
| 8.    | [HTTP Server Request Handle](#http-server-request-handle)                        |
| 9.    | [Server Response](#server-response)                                              |
| 10.   | [Behind the scenes of the Browser](#behind-the-scenes-of-the-browser)            |
| 11.   | [The browser's high level structure](#the-browsers-high-level-structure)         |
| 12.   | [Rendering Engine](#rendering-engine)                                            |
| 13.   | [The Main flow](#the-main-flow)                                                  |
| 14.   | [Parsing Basics](#parsing-basics)                                                |
| 15.   | [DOM Tree](#dom-tree)                                                            |
| 15.1. | [Why is the DOM slow?](#why-is-the-dom-slow)                                     |
| 16.   | [Render Tree](#render-tree)                                                      |
| 17.   | [Render tree's relation to the DOM tree](#render-trees-relation-to-the-dom-tree) |
| 18.   | [CSS Parsing](#css-parsing)                                                      |
| 19.   | [Layout](#layout)                                                                |
| 20.   | [Painting](#painting)                                                            |
| 21.   | [Trivia](#trivia)                                                                |
| 21.1. | [The birth of the web](#the-birth-of-the-web)                                    |
...
<p align="center">
  <img src="images/Example_of_an_iterative_DNS_resolver.svg" alt="Recursive DNS search"/>
</p>
...
<p align="center">
  <img src="images/layers.png" alt="Browser Components"/>
</p>
...
<p align="center">
  <img src="images/flow.png" alt="Rendering engine basic flow"/>
</p>
...
<p align="center">
  <img src="images/webkitflow.png" alt="Webkit main flow"/>
</p>
...
<p align="center">
  <img src="images/image011.png" alt="Source document to parse tree"/>
</p>
...
<p align="center">
  <img src="images/image017.png" alt="HTML parsing flow"/>
</p>
...
<p align="center">
  <img src="images/image015.png" alt="DOM Tree"/>
</p>
...
<p align="center">
  <img src="images/image025.png" alt="The render tree and the corresponding DOM tree"/>
</p>
